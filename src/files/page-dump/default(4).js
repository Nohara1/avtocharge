...
var mSearch2 = {
    ...
    numbers: {},
    selections: {},
    formatSliderValue: function (val) {
        var num = String(val).replace(/\s/g, '');
    ...
    handleSort: function () {
        ...
        $(document).on('click', this.options.sort_link, function () {
            ...
            if (dir) {
                sort = sort.split(mse2Config['method_delimeter'])[0];
    ...
    handleSlider: function () {
        ...
        $(mSearch2.options.slider).each(function () {
            ...
            imin.val(mSearch2.formatSliderValue(vmin));
            imax.val(mSearch2.formatSliderValue(vmax));
            $this.slider({
                min: vmin,
                max: vmax,
                values: [vmin, vmax],
                ...
                step: 1 / delimiter,
                stop: function (e, ui) {
                    imin.val(mSearch2.formatSliderValue(ui.values[0].toFixed(decimals)));
                    imax.val(mSearch2.formatSliderValue(ui.values[1].toFixed(decimals)));
                ...
                slide: function (e, ui) {
                    if (decimal) {
                        ...
                        imin.val(mSearch2.formatSliderValue(ui.values[0]));
                        imax.val(mSearch2.formatSliderValue(ui.values[1]));
                    }
                }
            });
            ...
            if (values[name]) {
                ...
                imin.val(mSearch2.formatSliderValue(tmp[0]));
                imax.val(mSearch2.formatSliderValue(tmp.length > 1 ? tmp[1] : tmp[0]));
            }
            ...
            imin.on('change keyup input click', function (e) {
                ...
                if (e.type != 'keyup' && e.type != 'input') {
                    if (parseFloat(raw) > vmax) {
                        raw = String(vmax);
                    }
                    else if (parseFloat(raw) < vmin) {
                        raw = String(vmin);
                    }
                    this.value = mSearch2.formatSliderValue(raw);
                } else {
                    this.value = raw;
                }
                if (e.type == 'change') {
                ...
                $this.slider('values', 0, parseFloat(raw));
            });
            ...
            imax.on('change keyup input click', function (e) {
                ...
                $this.slider('values', 1, parseFloat(raw));
            });
    ...
    getFilters: function () {
        ...
        $.map(this.filters.serializeArray(), function (n) {
            ...
            if (params[n.name]) {
                params[n.name] += mse2Config['values_delimeter'] + val;
            }
            else {
                params[n.name] = val;
            }
                        ...
                        switch (type) {
                            ...
                            default:
                                if (mSearch2.sliders[name]) {
                                    ...
                                    var rawCurrent = String(item.val()).replace(/\s/g, '');
                                    if (val != rawCurrent) {
                                        item.val(mSearch2.formatSliderValue(val)).trigger('click');
                                    }
                                } else {
        ...
        for (var filter in suggestions) {
            ...
            if (is_slider && !this.sliders[alias]['user_changed']) {
                ...
                if (imin.length) {
                    ...
                    imin.val(mSearch2.formatSliderValue(vmin.toFixed(imin.data('decimal')))).trigger('click');
                }
                ...
                if (imax.length) {
                    ...
                    imax.val(mSearch2.formatSliderValue(vmax.toFixed(imax.data('decimal')))).trigger('click');
                }
